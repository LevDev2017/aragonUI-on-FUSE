...
console.log('**************');
console.log(chains.getChainInformation(122).type);
console.log(chains.getChainInformation(1).type);
export const networkConfigs = {
  [chains.getChainInformation(122).type]: {
    isActive: true,
    addresses: {
      ensRegistry:
        // localEnsRegistryAddress || '0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e', 
        localEnsRegistryAddress || '0x9952dB34cff5E17B3843eD1e27e8A0Fb6849Bd27',  //FIXME
    ...
    settings: {
      chainId: 122,
      testnet: false,
      ...chains.getChainInformation(122),
      live: true,
    },
  },
